(function (cjs, an) {
	...
	(lib.mars1 = function () {
		this.initialize(img.mars1);
	}).prototype = p = new cjs.Bitmap();
	p.nominalBounds = new cjs.Rectangle(0, 0, 2000, 1000);
	...
	(lib.fullMap = function (mode, startPosition, loop, reversed) {
		...
		// Layer_1
		this.instance = new lib.mars1();
		this.instance.setTransform(2124.6, 0.15, 1.0623, 1.0623);

		this.instance_1 = new lib.mars1();
		this.instance_1.setTransform(0, 0, 1.0623, 1.0623);
	...
	p.nominalBounds = new cjs.Rectangle(0, 0, 4249.2, 1062.5);
	...
	(lib.savedAnMars_HTML5Canvas = function (mode, startPosition, loop, reversed) {
		...
		this.instance.setTransform(1966.25, 805.2, 1, 1, 10.7393, 0, 0, 2124.6, 531.1);
		...
		this.timeline.addTween(cjs.Tween.get(this.instance).to({ x: -123.1, y: 409.35 }, 499).wait(1));
	...
	lib.properties = {
		...
		opacity: 0.00,
		manifest: [
			{ src: "/assets/images/planets/mars1.png", id: "mars1" }
		],
		preloads: []
	};
