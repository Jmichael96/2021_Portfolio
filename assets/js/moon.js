(function (cjs, an) {
	...
	lib.ssMetadata = [
		{ name: "moon_atlas_1", frames: [[0, 0, 2048, 1024]] }
	];
	...
	(lib._9f85d6e9e35b5db03b4b6bc8161d2351 = function () {
	...
	(lib.fullMap = function (mode, startPosition, loop, reversed) {
		...
		// Layer_1
		this.instance = new lib._9f85d6e9e35b5db03b4b6bc8161d2351();
		this.instance.setTransform(2048, 0);

		this.instance_1 = new lib._9f85d6e9e35b5db03b4b6bc8161d2351();
	...
	p.nominalBounds = new cjs.Rectangle(0, 0, 4096, 1024);
	...
	(lib.savedAnMoon_HTML5Canvas = function (mode, startPosition, loop, reversed) {
		...
		this.instance.setTransform(1759.85, 725.2, 1.0448, 1.0448, 8.7327, 0, 0, 2048, 511.9);
		...
		this.timeline.addTween(cjs.Tween.get(this.instance).to({ x: -358.25, y: 400.45 }, 499).wait(1));
	...
	lib.properties = {
		...
		color: "#000000",
		opacity: 0.00,
	// moon image background thats being used
		manifest: [
			{ src: "/assets/images/planets/moon_atlas_1.png", id: "moon_atlas_1" }
		],
		preloads: []
	};
