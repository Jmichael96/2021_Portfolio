...
lib.ssMetadata = [
		{name:"callisto_atlas_1", frames: [[0,0,1800,900]]}
];
...
(lib.Callisto = function() {
	this.initialize(ss["callisto_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Callisto();
	this.instance.setTransform(2127.75,0,1.1822,1.1822);

	this.instance_1 = new lib.Callisto();
	this.instance_1.setTransform(0,0,1.1822,1.1822);
...
p.nominalBounds = new cjs.Rectangle(0,0,4255.8,1064);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1893.9,759.3,1,1,9.2107,0,0,2127.8,532);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-206.6,y:419.2},499).wait(1));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"/assets/images/planets/callisto_atlas_1.png", id:"callisto_atlas_1"}
	],
	preloads: []
};
